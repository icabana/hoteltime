...
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('WiFi', NULL, '<i class="fa fa-wifi vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('TV', NULL, '<i class="fa fa-television vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('Air Conditioning', NULL, '<i class="fa fa-snowflake-o vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('Bathroom', NULL, '<i class="fa fa-bath vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('Mini Bar', NULL, '<i class="fa fa-glass vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('Pets Allowed', NULL, '<i class="fa fa-paw vbo-icn-carat"></i>');
INSERT INTO `#__vikbooking_characteristics` (`name`,`icon`,`textimg`) VALUES ('Disabled Facilities', NULL, '<i class="fa fa-wheelchair vbo-icn-carat"></i>');
