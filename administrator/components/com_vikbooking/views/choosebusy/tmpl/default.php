...
<div class="table-responsive">
	...
	for ($i = 0, $n = count($reservs); $i < $n; $i++) {
		...
		<tr class="row<?php echo $k; ?>">
			...
			<td><a href="index.php?option=com_vikbooking&amp;task=editbusy<?php echo ($pvcm == 1 ? '&amp;vcm=1' : '').(!empty($pgoto) ? '&amp;goto='.$pgoto : ''); ?>&amp;cid[]=<?php echo $row['idorder']; ?>"><?php echo date(str_replace("/", $datesep, $df).' H:i', $row['checkin']); ?></a></td>
