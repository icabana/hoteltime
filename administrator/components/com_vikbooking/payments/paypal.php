...
class vikBookingPayment {
	...
	static function getAdminParameters () {
		return array(
				...
				'tls12' => array('type' => 'select', 'label' => 'Force TLS 1.2://if ON, the connection to PayPal will be established only through the TLS 1.2 protocol', 'options' => array('ON', 'OFF'))
		);
	}
	...
	public function validatePayment () {
		...
		if (isset($myPost['business'])) {
			$myPost['business'] = $this->params['account'];
		}
		//
