...
class JFormFieldVikslidesmanager extends JFormField {
	...
	private function loadFormData($type = 'add') {
		...
		//Slide Caption
		$form_data .= '<div class="vikslider-slideparam-block"><label title="'.JText::_('VIKCSSLIDECAPTIONDESC').'">'.JText::_('VIKCSSLIDECAPTION').'</label><input type="text" class="viksliderparam_'.$type.'_caption" filter="raw" /></div>';
		//Slide Readmore Link
