...
<br/>
<h4 style="text-align: center;"><?php echo "Documento Ckeck-in"; ?></h4>
<p> </p>
<?php
...
<table width="100%" align="center" border="0" cellspacing="1" cellpadding="2" border="1" style="border: 1px solid #363636;">
	<tr>
		<td align="center" valign="top"><strong><?php echo "Nombres"; ?></strong></td>
		<td align="center" valign="top"><strong><?php echo "Apellidos"; ?></strong></td>
		<td align="center" valign="top"><strong><?php echo "Fecha de LLegada"; ?></strong></td>
		<td align="center" valign="top"><strong><?php echo "Fecha de Salida"; ?></strong></td>
	</tr>
	<tr>
		<td align="center"><?php echo $customer['first_name']; ?></td>
		<td align="center"><?php echo $customer['last_name']; ?></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2" style="border: 1px solid #000000;">
	...
	<?php
	if (isset($customer['pax_data'][$k]) && count($customer['pax_data'][$k]) > 0) {
		?>
	<tr>
		<td align="left" valign="top" style="border-right: 1px solid #000000;"><strong><?php echo "Detalle de los Huespedes"; ?></strong></td>
		<td align="center" valign="top" style="border-right: 1px solid #000000;"><strong><?php echo "Nombres"; ?></strong></td>
		<td align="center" valign="top"><strong><?php echo "Apellidos"; ?></strong></td>
	</tr>
	<tr>
...
foreach ($customer_details as $key => $field) {
	...
	<?php
	if ($details_counter >= $details_per_row && (($rows_written * $details_per_row) + $details_counter) < count($customer_details)) {
		$details_counter = 0;
		$rows_written++;
		echo '</tr><tr>';
	}
...
if ($details_counter < $details_per_row) {
	for ($i = $details_counter; $i <= $details_per_row; $i++) {
		?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<tr>
		...
		<?php
		if (!empty($customer['signature']) && file_exists(VBO_ADMIN_PATH.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'idscans'.DIRECTORY_SEPARATOR.$customer['signature'])) {
			?>
			<img src="<?php echo VBO_ADMIN_URI; ?>resources/idscans/<?php echo $customer['signature'].'?'.time(); ?>">
			<?php
		}
		?>
		</td>
