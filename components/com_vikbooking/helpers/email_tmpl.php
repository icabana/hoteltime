 ...
 * {order_link} - Link to the booking details page in the front-end
								...
								<tr>
									<td style="padding: 10px; line-height: 1.4em;">
										<div style="min-height: 270px;">
											<h3 style="background:#78B8C4; display:inline-block; padding:5px 10px; text-transform:uppercase; font-size:16px; color:#fff;"><?php echo "TU RESERVA"; ?>:</h3>
											<div>
												<p><span><?php echo "No. de la Reserva"; ?>:</span> <span>{order_id}</span></p>
											</div>
											{confirmnumb_delimiter}
											<div>
												<p><span><?php echo "Numero de Confirmacion"; ?>:</span> <span>{confirmnumb}</span></p>
											</div>
											{/confirmnumb_delimiter}
											<div>
												<p><span><?php echo "Estado de la Reserva"; ?>:</span> <span class="{order_status_class}">{order_status}</span></p>
											</div>
											<div>
												<p><span><?php echo "Fecha de la Reserva"; ?>:</span> <span>{order_date}</span></p>
											</div>
										</div>
									</td>
								</tr>
						...
						<div style="width: 100%; max-width: 396px; display: inline-block; vertical-align: top; text-align: left;">
							<table width="90%" style="margin: 10px auto 0; padding: 5px; font-size: 14px; background:#f2f3f7;">
								<tr>
									<td style="padding: 10px; line-height: 1.4em;">
										<div style="min-height: 270px;">
											<h3 style="background:#78B8C4; display:inline-block; padding:5px 10px; text-transform:uppercase; font-size:16px; color:#fff;"><?php echo "DATOS PERSONALES"; ?>:</h3>
											<p>{customer_info}</p>
										</div>
									</td>
								</tr>
						...
						<div style="width: 100%; max-width: 396px; display: inline-block; vertical-align: top; text-align: left;">
							<table width="90%" style="margin: 10px auto 0; padding: 5px; font-size: 14px; background:#f2f3f7;">
								<tr>
									<td style="padding: 10px; line-height: 1.4em;">
										 <div>
											<p><span style="font-weight:600;"><?php echo "Fecha de Ckeck-In"; ?>:</span>
											<span>{checkin_date}</span></p>
										</div>
										<div class="hiredate">
											<p><span style="font-weight:600;"><?php echo "Fecha de Check-out"; ?>: </span>
						...
						<table width="95%" style="border-spacing: 0; margin: 10px auto 0; padding: 15px; font-size: 14px; background: #fff;">
							<tr>
								<td style="padding: 10px; line-height: 1.4em; text-align: left;">
									<div>
										<h3 style="background:#78B8C4; display:inline-block; padding:5px 10px; text-transform:uppercase; font-size:16px; color:#fff;"><?php echo "DETALLE DE LA RESERVA"; ?>:</h3>
						...
						<table width="95%" style="border-spacing: 0; margin: 0 auto; font-size: 14px; background: #fff;">
							<tr>
								<td style="line-height: 1.4em; text-align: left;">
									<div>
										<strong><?php echo "Para ver el detalle de la reserva, visite el siguiente enlace: "; ?>:</strong><br/>
										{order_link}
									</div>	
									<div>
