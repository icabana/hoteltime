					...
					<?php
						...
						<div class="vbo-promotion-room-block">
							...
							<div class="vbo-promotion-room-book-block">
								<a class="vbo-promotion-room-book-link" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$room['id'].'&checkin='.$promo['promo_from_ts'].'&promo='.$promo['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBOPROMOROOMBOOKNOW'); ?></a>
							</div>
						</div>
							<?php
						}
