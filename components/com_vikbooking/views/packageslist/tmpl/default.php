	...
	<div class="vbo-pkglist-pkg">
		...
		<div class="vbo-pkglist-pkg-bthree">
			...
			<div class="vbo-pkglist-pkg-details">
				<a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=packagedetails&pkgid='.$package['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBOPKGMOREDETAILS'); ?></a>
			</div>
		<?php
