...
<div class="vbo-availability-controls">
	<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&view=availability'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post" name="vbmonths">
		<?php echo $wmonthsel; ?>
	<?php
		...
		<div class="vbo-availability-room-details">
			...
			<div class="vbo-availability-room-details-last vbselectr">
				<div class="vbo-availability-room-details-last-inner">
					<a class="btn" id="vbo-av-btn-<?php echo $room['id']; ?>" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$room['id'].'&checkin=-1'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBAVAILBOOKNOW'); ?></a>
				</div>
				<div class="vbo-availability-room-details-last-checkin" id="vbo-av-checkin-<?php echo $room['id']; ?>"><i class="fa fa-sign-in"></i> <span></span></div>
			</div>
		</div>
