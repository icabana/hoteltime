	...
	?>
		...
		?>
			...
			<div class="vbselectordiv">
				<div class="vbselectr"><a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=roomdetails&roomid='.$r['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBSEARCHRESDETAILS'); ?></a></div>
			</div>
