...
if (VikBooking::allowBooking()) {
	...
	$selform = "<div class=\"vbdivsearch vbo-search-mainview\"><form action=\"".JRoute::_('index.php?option=com_vikbooking'.(!empty($pitemid) ? '&Itemid='.$pitemid : ''))."\" method=\"get\"><div class=\"vb-search-inner\">\n";
