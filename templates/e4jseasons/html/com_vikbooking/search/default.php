	...
	<div class="vbdialog-inner">
		<div class="vbdialog-top">
			...
			<div class="vbdialog-right">
				<div class="vbdialog-right-top vbdialog-rx-inner">
					...
					<div class="vbdialog-bottom">
						<button type="button" class="btn btn-grey" id="vbdialog-cancel" onclick="Javascript: vbDialogClose();"><?php echo JText::_('VBDIALOGBTNCANCEL'); ?></button>
						<button type="button" class="btn btn-green" id="vbdialog-confirm" onclick="Javascript: void(0);"><?php echo JText::_('VBDIALOGBTNCONTINUE'); ?></button>
					</div>
				</div>
			</div>
		</div>
...
<div class="vbo-results-head">
	<span class="vbo-results-checkin"><i class="fa fa-sign-in"></i> <span><?php echo date(str_replace("/", $datesep, $df), $checkin); ?></span></span>
	...
	foreach($rooms as $room) {
		if ($roomsnum > 1 && !in_array($indroom, $writeroomnum)) {
			...
			<div class="vbsearchproominfo">
				<span class="vbsearchnroom"><span><?php echo JText::_('VBSEARCHROOMNUM'); ?> <?php echo $indroom; ?></span></span>
				<span class="vbsearchroomparty"><i class="fa fa-users"></i> <span><?php echo $arrpeople[$indroom]['adults']; ?> <?php echo ($arrpeople[$indroom]['adults'] == 1 ? JText::_('VBSEARCHRESADULT') : JText::_('VBSEARCHRESADULTS')); ?> <?php echo ($showchildren && $arrpeople[$indroom]['children'] > 0 ? ", ".$arrpeople[$indroom]['children']." ".($arrpeople[$indroom]['children'] == 1 ? JText::_('VBSEARCHRESCHILD') : JText::_('VBSEARCHRESCHILDREN')) : ""); ?></span></span>
			</div>
			<?php
		}
		...
		<div class="room_item <?php echo $maindivclass; ?><?php echo $has_promotion === true ? ' vbo-promotion-price' : ''; ?>" id="vbcontainer<?php echo $indroom.'_'.$room[0]['idroom']; ?>">
			<div class="vblistroomblock">
				<div class="vbimglistdiv">
					<a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=searchdetails&roomid='.$room[0]['idroom'].'&checkin='.$checkin.'&checkout='.$checkout.'&adults='.$arrpeople[$indroom]['adults'].'&children='.$arrpeople[$indroom]['children'].'&tmpl=component'); ?>" class="vbmodalframe" target="_blank"><img class="vblistimg" alt="<?php echo $room[0]['name']; ?>" id="vbroomimg<?php echo $indroom.'_'.$room[0]['idroom']; ?>" src="<?php echo VBO_SITE_URI; ?>resources/uploads/<?php echo $room[0]['img']; ?>"/></a>
...
?>
		...
		<div class="goback">
			<a class="btn btn-grey" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=vikbooking&checkin='.$checkin.'&checkout='.$checkout); ?>"><?php echo JText::_('VBCHANGEDATES'); ?></a>
		</div>
