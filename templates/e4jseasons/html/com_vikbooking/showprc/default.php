...
foreach($arrpeople as $indroom => $aduch) {
	...
	<div class="room_buttons_box">
		...
		if($is_package === true) {
			?>
			<a class="btn btn-grey" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=packagedetails&pkgid='.$pkg['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : ''), false); ?>"><?php echo JText::_('VBBACK'); ?></a>
			<?php
		}else {
			?>
