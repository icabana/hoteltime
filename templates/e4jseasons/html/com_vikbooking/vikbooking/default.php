...
jQuery(function(){
	...
	if (intval($maxsearchnumrooms) > 1) {
		$roomsel = "<label for=\"vbo-roomsnum\">".JText::_('VBFORMROOMSN')."</label><div class=\"vbo-sel\"><span><select id=\"vbo-roomsnum\" name=\"roomsnum\" onchange=\"vbSetRoomsAdults(this.value);\">\n";
	...
	if (VikBooking::showCategoriesFront()) {
		...
		if ($dbo->getNumRows() > 0) {
			...
			$selform .= "<div class=\"vbo-search-categories\"><label for=\"vbo-formcategories\" class=\"vbformcategories\">" . JText::_('VBROOMCAT') . "</label><div class=\"vbo-sel\"><span><select id=\"vbo-formcategories\" name=\"categories\">";
			$selform .= "<option value=\"all\">" . JText::_('VBALLCAT') . "</option>\n";
			foreach ($categories as $cat) {
				$selform .= "<option value=\"" . $cat['id'] . "\">" . $cat['name'] . "</option>\n";
			}
			$selform .= "</select></span><i class=\"fa fa-sort\"></i></div></div>\n";
		}
	}
	...
	<div class="vbo-booking-modification-helper">
		<div class="vbo-booking-modification-helper-inner">
			...
			<div class="vbo-booking-modification-canc">
				<a href="<?php echo JRoute::_('index.php?option=com_vikbooking&task=cancelmodification&sid='.$this->mod_booking['sid'].'&id='.$this->mod_booking['id']); ?>">
